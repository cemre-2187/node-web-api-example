...
module.exports = forgotPassword = (name, password, resetURL) => {
                                                   ...
                                                   <td width="540" align="center" valign="top" style="padding:0;Margin:0;">
                                                      <table cellpadding="0" cellspacing="0" width="100%"
                                                         ...
                                                         <tbody>
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                               <td align="left" class="es-m-txt-c"
                                                                  ...
                                                                  <p
                                                                     ...
                                                                     Pintirim.com hesabınızı şifresini değiştirmek için bir
                                                                     istekte bulundunuz.
                                                                  </p>
                                                                  <p
                                                                     style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;line-height:24px;color:#4A4A4A;">
                                                                     Sistemimiz size <span style="color: darkred;">henüz aktif olmayan</span> yeni bir şifre
                                                                     olusturdu: <strong> ${password} </strong>
                                                                  </p>
                                                                  <p
                                                                     style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;line-height:24px;color:#4A4A4A;">
                                                                     <br />
                                                                  ...
                                                                  <p
                                                                     style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;line-height:24px;color:#4A4A4A;">
                                                                     Yeni şifrenizi onaylamak için lütfen "Şifremi Onayla"
                                                                     butonuna basınız!</p>
                                                                  <p
                                                                     style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;line-height:24px;color:#4A4A4A;">
                                                                     Eğer bir istekte bulunmadıysanız, lütfen bu mesajı
                                                                     görmezden geliniz.
                                                                  </p>
                                                               </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                               <td align="left" style="padding:0;Margin:0;">
                                                                  <span class="es-button-border"
                                                                     ...
                                                                     <a href="${resetURL}" class="es-button" target="_blank"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                               <td align="left" style="padding:0;Margin:0;">
                                                                  Eğer "Şifremi Sıfırla" butonu ile yönlendirme çalışmıyor
                                                                  ise aşağıda bulunan web sitesi adresini kopyalayıp,
                                                                  tarayıcınızın adres çubuğuna yapıştırıp, yönlendirme
                                                                  sağlayabilirsiniz. </br> ${resetURL}
                                                               </td>
                                                            </tr>
                                                         </tbody>
                                                      </table>
                                                                           ...
                                                                           <tr style="border-collapse:collapse;">
                                                                              <td align="right" width="100.00%"
                                                                                 ...
                                                                                 bgcolor="transparent"><a target="_blank"
                                                                                    ...
                                                                                    href="mailto:info@visionf.com.tr"><img
                                                                                       src="https://ll.stripocdn.email/content/guids/CABINET_55f8c7f850a2da0484353b31bf893ec2/images/80161542981842805.png"
                                                                                       alt="info@visionf.com.tr"
                                                                                       title="info@visionf.com.tr"
                                                                                       align="absmiddle" width="30"
                                                                                       style="display:inline !important;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;padding-right:10px;">info@visionf.com.tr</a>
                                                                              </td>
                                                                           </tr>
                                                                        </tbody>
                                                                     </table>
